...
# ── entry points (reemplazar por tokens especiales en modelo grande) ──
BOS             = "<bos>"
EOS             = "<eos>"
SEP             = "<mask>"
USER            = "[usuario]"
...
def crear_dataset(output_path=r"Models Dev/Rosab/finetuning_dataset.txt"):
    ejemplos = []
...
def tokenizar_dataset(
    input_path  = r"Models Dev/Rosab/finetuning_dataset.txt",
    output_bin  = r"Models Dev/Rosab/Finetuning_tokens.bin",
